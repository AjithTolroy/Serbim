...
$sql = ("INSERT INTO productsstore (comment) VALUES ('$comment')");
...
<h2>why India is lack of product based companies ?</h2>


<h3><img src= "http://serbim.in/img/product.jpg" width="600" height="400" title="product" alt="product" /></h3>
...
$sql = "SELECT comment FROM productsstore";
