...
$sql = ("INSERT INTO moviesstore (comment) VALUES ('$comment')");
...
<h2>why today's movies are becoming worst than ever?</h2>


<h3><img src= "http://serbim.in/img/movies.jpg" width="600" height="400" title="movies" alt="movies" /></h3>
...
$sql = "SELECT comment FROM moviesstore";
