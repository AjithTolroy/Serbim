...
$sql = ("INSERT INTO bookstore (comment) VALUES ('$comment')");
...
<h2>How to publish a book?</h2>


<h3><img src= "http://serbim.in/img/book.jpg" width="600" height="400" title="book" alt="book" /></h3>
...
$sql = "SELECT comment FROM bookstore";
