...
$sql = ("INSERT INTO companystore (comment) VALUES ('$comment')");
...
<h2>which is the best company to work and why?</h2>


<h3><img src= "http://serbim.in/img/company.jpg" width="600" height="400" title="company" alt="company" /></h3>
...
$sql = "SELECT comment FROM companystore";
